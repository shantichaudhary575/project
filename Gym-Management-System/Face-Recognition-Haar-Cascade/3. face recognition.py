...
# names = ['', 'Shanti', 'Binita', 'Suman']  # key in names, start from the second place, leave first empty
...
# Set a threshold for confidence level to classify as unknown
